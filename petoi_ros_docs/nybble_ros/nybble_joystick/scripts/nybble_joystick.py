...
class RobotArmController:
    def __init__(self):
        ...
        self.joint2_pub = rospy.Publisher('/head_joint_position_controller/command', Float64, queue_size=10)
    ...
    def joy_callback(self, joy_msg):
        ...
        joint2_command = joy_msg.axes[1] 
        # Publish control commands
        self.joint1_pub.publish(joint1_command)
        self.joint2_pub.publish(joint2_command)
